...
(function () {
  ...
  var D = {
    ...
    'Te ayudamos por Telegram cuando lo necesitás.':'We help you over Telegram whenever you need it.',
    ...
    'Cuenta gratuita en la comunidad':'Free community account','Recursos en videos y PDF':'Video and PDF resources','Herramientas del taller':'Workshop tools',
    'Datos guardados en tu cuenta':'Data saved in your account','Empezar gratis':'Start for free',
    'Comunidad Mensual':'Monthly Community','Tu cuenta':'Your account','Planes':'Plans','Hecho con impresoras 3D en Argentina':'Made with 3D printers in Argentina','/mes':'/month',
    ...
    'Suscribirme':'Subscribe','2 meses gratis':'2 months free','Pronto':'Soon',
    ...
    '2 meses sin cargo ($36.000 de ahorro)':'2 months at no cost ($36,000 in savings)',
    ...
    'Como prefieras: el plan mensual cuesta $18.000 y se renueva mes a mes sin permanencia, y el plan anual cuesta $180.000 — ahorrás $36.000 (2 meses gratis) y el precio queda congelado todo el año.':'Whichever you prefer: the monthly plan costs $18,000 and renews month to month with no lock-in, and the yearly plan costs $180,000 — you save $36,000 (2 months free) and the price stays locked all year.',
    ...
    '2 meses sin cargo (US$30 de ahorro)':'2 months at no cost (US$30 in savings)',
    'Equivale a US$12,50 por mes · ahorrás US$30':'Works out to US$12.50/month · you save US$30',
    'Empezá hoy — es gratis':'Start today — it is free',
    'Creá tu cuenta, probá la calculadora y descubrí por qué cada vez más makers manejan su taller con Printika Tools.':'Create your account, try the calculator and see why more and more makers run their workshop with Printika Tools.',
